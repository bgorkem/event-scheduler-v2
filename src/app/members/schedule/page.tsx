...
export default async function SchedulePage() {
    ...
    const selectedDate = Object.keys(sessionsByDate)[0] || new Date().toISOString().slice(0, 10)
    ...
    return (
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div className="mb-6">
                    <div className="bg-yellow-50 border border-yellow-200 text-yellow-800 px-4 py-3 rounded-md">
                        ...
                        <p className="mt-1 text-sm">
                            You have {conflictSessions.length} overlapping sessions. Consider adjusting your schedule.
                        </p>
                    </div>
                </div>
            )}
                ...
                {sessionsByDate[selectedDate]?.length ? (
                    <div className="space-y-4">
                        {sessionsByDate[selectedDate]
                            ...
                            .map((session: any) => (
                                <Card key={session.session_id} className={`${session.has_conflict ? 'border-yellow-300 bg-yellow-50' : ''}`}>
                                    <CardHeader>
                    ...
                    <div className="text-center py-12">
                        ...
                        <p className="text-gray-600 mb-4">You don&apos;t have any sessions scheduled for this day.</p>
                        <Button disabled>
            ...
            <div className="mt-12 grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <Card>
                    <CardContent className="text-center p-4">
                        <div className="text-2xl font-bold text-red-600">{conflictSessions.length}</div>
