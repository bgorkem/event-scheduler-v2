...
export default function AdminPage() {
  ...
  const handleParseUrl = async () => {
    ...
    try {
      ...
      alert(
        `Successfully parsed ${parsedSessions.length} sessions from the URL!`
      );
    } catch (error) {
      ...
      <Tabs defaultValue="conferences" className="space-y-6">
        ...
        <TabsContent value="conferences" className="space-y-6">
          <div className="flex justify-between items-center">
            ...
            <Dialog
              open={isAddingConference}
              onOpenChange={setIsAddingConference}
            >
              ...
              <DialogContent className="max-w-2xl">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex justify-end space-x-2">
                    <Button
                      variant="outline"
                      onClick={() => setIsAddingConference(false)}
                    >
                      Cancel
                    </Button>
                  ...
                  <div className="flex justify-between items-start">
                    ...
                    <div className="flex space-x-1">
                      ...
                      <Button
                        ...
                        variant="ghost"
                        onClick={() =>
                          handleDeleteConference(conference.conference_id)
                        }
                      >
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <Select
                        ...
                        onValueChange={(value) =>
                          setSessionForm({ ...sessionForm, track: value })
                        }
                      >
                        <SelectTrigger>
                        ...
                        <SelectContent>
                          <SelectItem value="Data Strategy">
                            Data Strategy
                          </SelectItem>
                          <SelectItem value="Data Engineering and Streaming">
                            Data Engineering and Streaming
                          </SelectItem>
                          <SelectItem value="Artificial Intelligence">
                            Artificial Intelligence
                          </SelectItem>
                          <SelectItem value="Data and AI Governance">
                            Data and AI Governance
                          </SelectItem>
                          <SelectItem value="Data Warehousing">
                            Data Warehousing
                          </SelectItem>
                          <SelectItem value="Data Lakehouse Architecture and Implementation">
        ...
        <TabsContent value="ai-parser" className="space-y-6">
          <div>
            <h2 className="text-2xl font-semibold mb-4">
              AI Conference Parser
            </h2>
            <p className="text-gray-600 mb-6">
              Upload conference schedules from web URLs using intelligent AI
              parsing. Our AI will extract sessions, speakers, and details
              automatically.
            </p>
          </div>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Enter a conference website URL to automatically extract session
                information
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              ...
              {loading && (
                <div className="bg-blue-50 border border-blue-200 text-blue-700 px-4 py-3 rounded-md">
                  <div className="flex items-center">
                    <Upload className="h-4 w-4 mr-2 animate-spin" />
                    AI is parsing the conference schedule... This may take a few
                    moments.
                  </div>
                </div>
              )}
